          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="{{ route('roles.all') }}">
                      <span class="nav-main-link-name">View All</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="{{ route('roles.add') }}">
                      <span class="nav-main-link-name">Create New Role</span>
                    </a>
                  </li>
                </ul>
              </li>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="dropdown d-inline-block ms-2">
              <button type="button" class="btn btn-sm btn-alt-secondary d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle" src="{{ asset( str_replace('public', 'storage', Auth::user()->image_path)) }}" alt="Header Avatar" style="width: 21px;">
