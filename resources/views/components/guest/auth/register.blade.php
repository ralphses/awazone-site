  ...
  <div class="breadcrumb__area breadcrumb-height p-relative grey-bg" data-background="{{ asset('guest/img/breadcrumb/breadcrumb.jpg') }}">
     ...
     <div class="row">
        <div class="col-xxl-12">
           <div class="breadcrumb__content text-center">
              <h3 class="breadcrumb__title">Sign Up Page</h3>
           ...
           <div class="tp-login-wrapper login-space d-flex justify-content-center">
              <div id="login" class="tplogin">
                 <div class="tplogin__title">
                    <h3 class="tp-login-title">Create New Account</h3>
                 </div>
                 <div class="tplogin__form">
                    <form action="{{ route('register') }}" method="POST">
                     ...
                     <div class="tp-mail">
                         ...
                         <input type="text" id="name" placeholder="Fullname here" id="name" name="name">
                       ...
                       <div class="tp-login-button">
                          <button class="tp-btn-blue-square w-100" type="submit"><span>Register</span></button>
                       </div>
