        ...
        <div class="row push">
          ...
          <div class="col-lg-8 col-xl-5">
            ...
            <div class="mb-4">
                ...
                <input class="form-control" type="text" value="{{ old('role_name') }}" id="example-file-input" name="role_name">
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control" id="example-textarea-floating" name="role_description" style="height: 100px" placeholder="Briefly descrip this role">{{ old('role_description') }}</textarea>
            </div>
                    ...
                    @foreach ($authorities as $authority)
                        <div class="space-y-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="{{ $authority }}" id="{{ $authority }}" name="authorities[]" >
